      ...
      <?php 
        ...
        $rsDetalle = mysqli_query($con, $queryDetalle) or die ("Error de consulta");         
              while ($Detalle = mysqli_fetch_array($rsDetalle)) {
                ...
                echo '<h5>';
                echo '<strong>';
                echo "<span class='badge m-1 p-2 badge-pill mdb-color'>$Detalle[6]</span>";
                echo '</strong>';
                echo '</h5>';
                echo '';
                echo '<p class="h6 p-1 m-1">Referencia: </p>';
                echo '';
                echo "<img class='img-responsive center-block img-thumbnail m-1'  src='../Vista/Img/$Detalle[2].png' style='width: 250px; height: 180px;'>";
                echo '<hr>';
                echo '<p class="h6 p-1 m-1">Materiales: </p>';
                echo '';
                echo "<p class='text-left p-3 m-1'>$Detalle[3]</p>";
                echo '<hr>';
