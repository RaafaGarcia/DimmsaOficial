                              ...
                              <table class="table table-hover ">
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td>
                                        <?php echo"
                                        <button type='button' class='btn btn-sm btn-success btn-block openBtn' value=".$Producto[0]." data-toggle='modal' data-target='#editarModal'><i class='fas fa-edit fa-lg mr-1 white-text'></i> Editar</button>
